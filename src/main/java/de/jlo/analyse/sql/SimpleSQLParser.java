...
import de.jlo.analyse.StringReplacer;
...
public final class SimpleSQLParser {
    ...
    static String[]         plsqlKeyWords   = {
            ...
            "CREATE TRIGGER",
            "BEGIN"                        };
    private static final String insertUpdateTableRegex = "(update|into)[\\s]{1,}([a-z_]{1}[a-z0-9_\\.]*)";
    ...
    public SimpleSQLParser() {
    	...
    	if (insertUpdateTablePattern == null) {
    		insertUpdateTablePattern = Pattern.compile(insertUpdateTableRegex, Pattern.CASE_INSENSITIVE);
    	}
    }
    ...
    public void parseScript(String text) {
        ...
        if (parserDisabled) {
            ...
            if (text.length() > 1) {
                    ...
                    if (inStringConstant == false && inLineComment == false && inBlockComment == false) {
                        if (c == '\'') { // String-Konstante ??
                            ...
                            if (endOfStatement) { // vorheriges Statement-Ende gefunden,
                                // nun sinnvollen Start des n�chsten finden
                        ...
                        // das Ende der zu �berspringenden Textpassagen finden
                        if (inLineComment) {
                ...
                } // Ende der ersten Schleife in a steht nun der Beginn der zu �berspringenden Textstelle
	...
	public static List<String> findFromTables(String code) {
	...
	public static List<String> findWithNames(String sql) {
	...
	public static String findInsertUpdateTables(String sql) {
		Matcher matcher = insertUpdateTablePattern.matcher(sql);
		while (matcher.find()) {
